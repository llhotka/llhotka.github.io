...
the underlying entity the previously assigned ID could become confusing if they
no more reflect reality. Hence, a better practice is to use opaque strings, as Home
Assistant does internally. and Emacs can generate them easily. I use
