...
But – is this system for everybody? Probably not. If you aren't an Emacs user yet,
it might not be very effective to learn the editor and the Org mode just for
the sake of configuring Home Assistant. Moreover, the literate approach requires
certain extra effort to **....**, si it isn't for
someone who wants to get things done quickly. Finally, I think beginners are better
off using the Home Assistant web UI that is more intuitive. 
